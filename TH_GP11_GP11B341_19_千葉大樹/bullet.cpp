...
// グローバル変数
//*****************************************************************************
LPDIRECT3DTEXTURE9		D3DTextureBullet = NULL;		// テクスチャへのポリゴン

BULLET					bulletWk[BULLET_MAX];			// バレット構造体
LPDIRECTSOUNDBUFFER8	bulletSE;						// SE用バッファ
...
HRESULT InitBullet(int type)
{
	...
	for (int i = 0; i < BULLET_MAX; i++, bullet++)
	{
		...
		bullet->Texture = D3DTextureBullet;					// テクスチャ情報
