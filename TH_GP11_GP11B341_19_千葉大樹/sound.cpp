...
const TCHAR* soundFilename[] = {
	_T("data/BGM/sample00.wav"),
	_T("data/BGM/sample01.wav"),
	_T("data/BGM/sample02.mid")
	_T("data/SE/bomb00.wav"),
	_T("data/SE/defend00.wav"),
	_T("data/SE/defend01.wav"),
	_T("data/SE/hit00.wav"),
	_T("data/SE/laser00.wav"),
	_T("data/SE/lockon00.wav"),
	_T("data/SE/shot00.wav"),
	_T("data/SE/shot01.wav"),
};

// グローバル変数
IDirectSound8 *DirectSound = NULL;	// サウンドインターフェース
LPDIRECTSOUNDBUFFER8 SE[20];
// サウンドの初期化
// hWnd:ウィンドウハンドル
...
LPDIRECTSOUNDBUFFER8 LoadSound( int no )
{
	...
	if (FAILED(buffer->Lock(0, 0, &pBlock, &dwSize, NULL, NULL, DSBLOCK_ENTIREBUFFER)))
		return NULL;
	...
	// バッファロック解除
	buffer->Unlock(pBlock, dwSize, 0, 0);
...
void PlaySound(LPDIRECTSOUNDBUFFER8 buffer, int flag/*=0*/ )
...
// 音を止める
void StopSound( LPDIRECTSOUNDBUFFER8 buffer )
{
	DWORD status;
